    ...
    public partial class Quik : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "booking001", new DateTime(2024, 10, 4, 0, 0, 0, 0, DateTimeKind.Local), 20000m, new DateTime(2024, 10, 4, 14, 27, 11, 514, DateTimeKind.Local).AddTicks(5285), 4, "payment001", 180000m, "space001", new DateTime(2024, 10, 4, 12, 27, 11, 514, DateTimeKind.Local).AddTicks(5280), "Confirmed", 200000m, "john_doe" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "payment001", 50.00m, "booking001", new DateTime(2024, 10, 4, 11, 27, 11, 514, DateTimeKind.Local).AddTicks(5303), "Credit Card", "Success", "https://example.com/payment/payment001", "00", "VNPay12345" });
