    ...
    public partial class QuikDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "booking001", new DateTime(2024, 9, 25, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 9, 25, 18, 36, 18, 250, DateTimeKind.Local).AddTicks(6958), "space001", new DateTime(2024, 9, 25, 16, 36, 18, 250, DateTimeKind.Local).AddTicks(6953), "Confirmed", 50.00m, "john_doe" });

            migrationBuilder.InsertData(
                table: "Payments",
                columns: new[] { "PaymentId", "Amount", "BookingId", "PaymentDate", "PaymentMethod" },
                values: new object[] { "payment001", 50.00m, "booking001", new DateTime(2024, 9, 25, 15, 36, 18, 250, DateTimeKind.Local).AddTicks(6970), "Credit Card" });
