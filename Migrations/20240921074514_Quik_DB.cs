...
{
    /// <inheritdoc />
    public partial class QuikDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Bookings",
                columns: new[] { "BookingId", "BookingDate", "EndTime", "SpaceId", "StartTime", "Status", "TotalAmount", "UserId" },
                values: new object[] { "booking001", new DateTime(2024, 9, 21, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2024, 9, 21, 17, 45, 14, 737, DateTimeKind.Local).AddTicks(3892), "space001", new DateTime(2024, 9, 21, 15, 45, 14, 737, DateTimeKind.Local).AddTicks(3887), "Confirmed", 50.00m, "john_doe" });

            migrationBuilder.InsertData(
                table: "Payments",
                columns: new[] { "PaymentId", "Amount", "BookingId", "PaymentDate", "PaymentMethod" },
                values: new object[] { "payment001", 50.00m, "booking001", new DateTime(2024, 9, 21, 14, 45, 14, 737, DateTimeKind.Local).AddTicks(3905), "Credit Card" });
